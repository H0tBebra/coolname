...
#w2 = GameSprite('stena.png', 370, 100, 50, 400) по вертикали
w2 = GameSprite('stena.png', 370, 100, 50, 400)
barriers.add(w1)
barriers.add(w2)
#создаем спрайты
packman = Player('tesak.png', 5, win_height - 80, 80, 80, 0, 0)
monster = Enemy('gayshin.png', win_width - 80, 180, 80, 80, 2)
monsters.add(monster)
final_sprite = GameSprite('zlodey.png', win_width - 85, win_height - 180, 80, 80)
finish = False
#игровой цикл
run = True
while run:
